            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form">
                        ...
                        <form action="{{route('front.message.store')}}" method="post" role="form" id="formMessage">
                            @csrf
                            ...
                            @auth
                                <div class="form-group">
                                    ...
                                    @error('name')
                                    <div class="mess alert alert-danger">{{$message}}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                  ...
                  <textarea class="form-control" name="message" rows="5" data-rule="required"
                            ...
                            <div class="text-center">
                                <button id="submitForm" type="submit" title="Send Message">Send Message</button>
                            </div>
                        </form>
                    </div>
