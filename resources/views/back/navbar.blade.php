<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="back/index.html">
            <img src="{{url('back/assets/images/logo.svg')}}" alt="logo" /> </a>
        <a class="navbar-brand brand-logo-mini" href="back/index.html">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown language-dropdown">
                <a class="nav-link dropdown-toggle px-2 d-flex align-items-center" id="LanguageDropdown" href="back/#"
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                <a class="nav-link count-indicator" id="messageDropdown" href="back/#" data-toggle="dropdown"
                   aria-expanded="false">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link count-indicator" id="notificationDropdown" href="back/#" data-toggle="dropdown">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
                <a class="nav-link dropdown-toggle" id="UserDropdown" href="back/#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    ...
                    <a class="dropdown-item" href="{{route('index')}}">بازگشت به سایت</a>
                    <a class="dropdown-item">پروفایل من <span class="badge badge-pill badge-danger">1</span><i
                            class="dropdown-item-icon ti-dashboard"></i></a>
                    <form action="{{route('logout')}}" method="post">
                        @csrf
                        <a style="cursor: pointer" onclick="submitForm()" class="dropdown-item">خروج<i class="dropdown-item-icon ti-power-off"></i></a>
                    </form>
                    <script>
                        function submitForm() {
                            $('form').submit();
